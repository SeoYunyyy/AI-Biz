...
"[project]/app/api/contents/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const db = admin();
    const { data, error, count } = await db.from('contents').select('id, url, content_type, title, thumbnail_url, author, metadata, hashtags, topics, moods, collection_id, analysis_status, saved_at', {
        count: 'exact'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a7st.3._.js.map