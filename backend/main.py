...
from backend.services.embedding import run as embed, generate_embedding
from backend.services.thumbnail_vision import analyze_thumbnail
...
async def ingest(req: IngestRequest):
    ...
    try:
        ...
        # 6-1. 유사 콘텐츠 검색
        from backend.services.embedding import generate_embedding, build_embed_text
